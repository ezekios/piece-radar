            ...
            <div class="mx-auto w-full max-w-3xl">
                ...
                <div class="mt-3 space-y-3">
                    ...
                    <section class="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
                        ...
                        <dl class="mt-3 grid gap-3 text-sm sm:grid-cols-3">
                            <div>
                                ...
                                <dd class="mt-1 font-black text-zinc-900">{{ $scrapyard?->name ?? 'Non renseigné' }}</dd>
                            </div>

                            <div>
                                <dt class="font-medium text-zinc-500">Ville</dt>
                                <dd class="mt-1 font-black text-zinc-900">{{ $scrapyard?->city ?? 'Non renseignée' }}</dd>
                            </div>

                            @if ($scrapyard?->phone)
                                <div>
                                    <dt class="font-medium text-zinc-500">Téléphone</dt>
                                    <dd class="mt-1 font-black text-zinc-900">{{ $scrapyard->phone }}</dd>
                                </div>
                            @endif
                        </dl>
                    </section>
                    ...
                    @if ($partHoldRequest->customer_message)
                        <section class="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
                            <h2 class="text-base font-black text-zinc-950">Message envoyé</h2>
