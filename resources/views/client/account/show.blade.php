        ...
        <main class="mx-auto min-h-screen w-full max-w-5xl px-4 pb-24 pt-5 sm:px-6 sm:pb-10 lg:px-8">
            <div class="mx-auto w-full max-w-3xl">
                ...
                <section class="mt-4 grid gap-3 sm:grid-cols-2">
                    <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                        <p class="text-xs font-black uppercase text-zinc-500 dark:text-zinc-400">Nom</p>
                        <p class="mt-1 text-lg font-black text-zinc-950 dark:text-zinc-50">{{ $user->name }}</p>
                    </div>

                    <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                        <p class="text-xs font-black uppercase text-zinc-500 dark:text-zinc-400">Rôle</p>
                        <p class="mt-1 text-lg font-black text-zinc-950 dark:text-zinc-50">Client</p>
                    </div>

                    <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                        <p class="text-xs font-black uppercase text-zinc-500 dark:text-zinc-400">Email</p>
                        <p class="mt-1 break-words text-lg font-black text-zinc-950 dark:text-zinc-50">{{ $user->email }}</p>
                    </div>

                    <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                        <p class="text-xs font-black uppercase text-zinc-500 dark:text-zinc-400">Téléphone</p>
                        <p class="mt-1 text-lg font-black text-zinc-950 dark:text-zinc-50">{{ $user->phone ?: 'Non renseigné' }}</p>
                    </div>
                </section>
                ...
                <section class="mt-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        <div>
                            <h2 class="text-base font-black text-zinc-950 dark:text-zinc-50">Informations personnelles</h2>
                        ...
                        <a href="{{ route('client.requests.index') }}" class="inline-flex items-center justify-center rounded-2xl bg-[#FC8505] px-4 py-2 text-sm font-black text-white shadow-sm transition hover:bg-[#E87804] focus:outline-none focus:ring-2 focus:ring-[#FC8505] focus:ring-offset-2 dark:focus:ring-offset-zinc-950">
                            Mes demandes
                        </a>
                    </div>
                    ...
                    <form method="POST" action="{{ route('client.account.update') }}" class="mt-4 space-y-4">
                        ...
                        <div>
                            <label for="name" class="text-sm font-black text-zinc-900 dark:text-zinc-100">Nom</label>
                            <input
                                id="name"
                                name="name"
                                type="text"
                        ...
                        <div>
                            <label for="phone" class="text-sm font-black text-zinc-900 dark:text-zinc-100">Téléphone</label>
                            <input
                                id="phone"
                                name="phone"
                                type="tel"
                        ...
                        <div>
                            <p class="text-sm font-black text-zinc-900 dark:text-zinc-100">Email</p>
                            <p class="mt-2 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-800 px-3 py-3 text-sm font-bold text-zinc-600 dark:text-zinc-400">
                                {{ $user->email }}
                            </p>
                        </div>
                ...
                <section class="mt-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                    <h2 class="text-base font-black text-zinc-950 dark:text-zinc-50">Modifier mon mot de passe</h2>
                    <p class="mt-1 text-sm font-medium leading-6 text-zinc-600 dark:text-zinc-400">
                    ...
                    <form method="POST" action="{{ route('client.account.password.update') }}" class="mt-4 space-y-4">
                        ...
                        <div>
                            <label for="current_password" class="text-sm font-black text-zinc-900 dark:text-zinc-100">Mot de passe actuel</label>
                            <div class="relative mt-2">
                                <input
                                    ...
                                    class="h-12 w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800 px-3 pr-12 text-sm font-medium text-zinc-900 dark:text-zinc-100 focus:border-[#FC8505] focus:outline-none focus:ring-2 focus:ring-[#FC8505]/20"
                                >
                                <button
                                    type="button"
                                    class="absolute inset-y-0 right-0 inline-flex w-12 items-center justify-center rounded-r-xl text-zinc-500 dark:text-zinc-400 transition hover:text-[#FC8505] focus:outline-none focus:ring-2 focus:ring-[#FC8505] focus:ring-inset"
                        ...
                        <div>
                            <label for="password" class="text-sm font-black text-zinc-900 dark:text-zinc-100">Nouveau mot de passe</label>
                            <div class="relative mt-2">
                                <input
                                    id="password"
                                    name="password"
                        ...
                        <div>
                            <label for="password_confirmation" class="text-sm font-black text-zinc-900 dark:text-zinc-100">Confirmation du nouveau mot de passe</label>
                            <div class="relative mt-2">
                                <input
