    ...
    <body class="bg-[#F8F7F4] font-sans text-zinc-950 antialiased">
        <main class="mx-auto flex min-h-screen w-full max-w-5xl items-center px-4 py-8 sm:px-6 lg:px-8">
            <section class="mx-auto w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-6">
                ...
                <h1 class="mt-2 text-2xl font-black leading-tight text-zinc-950">Créer un compte client</h1>
                ...
                <form method="POST" action="{{ route('client.register.store') }}" class="mt-5 space-y-4">
                    ...
                    <div>
                        <label for="name" class="text-sm font-bold text-zinc-700">Nom complet</label>
                        <input
                            id="name"
                            name="name"
                            type="text"
                    ...
                    <div>
                        <label for="phone" class="text-sm font-bold text-zinc-700">Téléphone</label>
                        <input
                            id="phone"
                            name="phone"
                            type="tel"
