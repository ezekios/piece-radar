                    ...
                    <nav class="flex flex-wrap items-center gap-2" aria-label="Navigation principale">
                        ...
                        @else
                            @if ($isClient)
                                ...
                                <a href="{{ route('notifications.index') }}" class="inline-flex h-10 items-center justify-center rounded-xl border border-orange-100 bg-white px-3 text-sm font-black text-[#FC8505] transition hover:border-orange-200 hover:text-[#E87804] focus:outline-none focus:ring-2 focus:ring-[#FC8505] focus:ring-offset-2">
                                    Notifications
                                </a>
                            @endif
