                        ...
                        <x-ui.card as="article" padding="p-4 sm:p-5">
                            <div class="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1.45fr)_minmax(13rem,0.7fr)_minmax(9rem,0.55fr)] lg:items-center">
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1.5 break-words text-base font-black text-zinc-950">{{ $user->name }}</p>
                                </div>

                                <div class="min-w-0">
                                    <p class="text-xs font-black uppercase tracking-[0.12em] text-zinc-400">Email</p>
                                    <p class="mt-1.5 break-words text-sm font-semibold leading-5 text-zinc-700">{{ $user->email }}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1.5 text-sm font-black text-zinc-700">{{ $user->created_at?->format('d/m/Y') }}</p>
                                </div>
                            </div>
                        </x-ui.card>
                    @endforeach
